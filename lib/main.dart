        ...
        body: SafeArea(child: Column(children: [
          ...
          Expanded(child: ListView(padding: const EdgeInsets.fromLTRB(22, 18, 22, 20), children: [
            ...
            Container(height: 205, decoration: BoxDecoration(color: panel, borderRadius: BorderRadius.circular(22), border: Border.all(color: line)), clipBehavior: Clip.antiAlias, child: Stack(children: [
              ...
              Positioned(left: 14, bottom: 12, child: Container(padding: const EdgeInsets.symmetric(horizontal: 9, vertical: 6), decoration: BoxDecoration(color: Colors.black.withValues(alpha: .72), borderRadius: BorderRadius.circular(9)), child: Text('${exerciseIndex + 1}'.padLeft(2, '0'), style: const TextStyle(fontWeight: FontWeight.w900, fontSize: 11)))),
            ])),
